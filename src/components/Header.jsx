...
export default function Header({ theme, onToggleTheme }) {
  return (
    <header
      className="sticky top-0 z-50 flex items-center justify-between h-16 px-20 max-[1280px]:px-10 max-[768px]:px-4 transition-colors duration-350"
      style={{
    ...
    >
      {/* Left */}
      <div className="flex items-center gap-10 max-[768px]:gap-4">
        ...
        <nav className="flex gap-1.5 max-[768px]:hidden">
      ...
      <div className="flex items-center gap-3">
        ...
        <div
          ...
          style={{ background: 'linear-gradient(135deg, #3D91FF, #6BABFF)' }}
          aria-label="프로필"
        >
