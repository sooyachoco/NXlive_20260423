      ...
      <div className="grid grid-cols-4 max-[1280px]:grid-cols-3 max-[1024px]:grid-cols-2 max-[768px]:grid-cols-1 gap-5">
        {vods.map((v, i) => (
          <a key={i} href="#" className="cursor-pointer no-underline group" style={{ color: 'inherit' }}>
            <div className="relative w-full rounded-[10px] overflow-hidden transition-transform duration-250 group-hover:scale-[1.02]" style={{ aspectRatio: '16/9' }}>
              <div className="w-full h-full transition-[filter] duration-250 group-hover:brightness-[1.15]" style={{ background: v.color }} />
            ...
            <div
              className="mt-2.5 text-[13px] font-medium leading-[1.4] line-clamp-2 transition-colors"
